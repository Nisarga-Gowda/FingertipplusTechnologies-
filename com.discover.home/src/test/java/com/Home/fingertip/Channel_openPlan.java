...
public class Channel_openPlan extends BaseTest {
	@Test
	public void channel_openplan() throws Throwable
	{
	Login l=new Login();
	l.login();
...
f.clickChannelSearch(fl.getPropValue(CHANNEL_PROP_PATH, "PlanTitle"));
Thread.sleep(10000);
f.setListOfSearch();
Thread.sleep(15000);
